...
// delete sharedObj['react-native-paper']
...
export default (env) => {
  ...
  return {
    ...
    resolve: {
      ...
      // },
      alias: {
        axios: new URL('./node_modules/axios/index.js', import.meta.url).pathname,
        ...
        'react-native-paper': path.join(dirname, './node_modules/react-native-paper/lib/commonjs'),
      },
    },
    /**
     * Configures output.
